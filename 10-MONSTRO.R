...
modelo01 <- ts(modelo01,start = 2015-2018, frequency = 12) 
...
plot(modelo02, main="Previsto e Observado AR2", plot.type="single",ylab="Data", xlab="Inflação", col=c("Blue","Black"))
